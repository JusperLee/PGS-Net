...
class LRS3Dataset(Dataset):
    def __init__(
        ...
        if n_src not in [1, 2, 3]:
            raise ValueError("{} is not in [1, 2, 3]".format(n_src))
